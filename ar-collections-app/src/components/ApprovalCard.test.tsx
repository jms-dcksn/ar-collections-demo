...
describe('ApprovalCard', () => {
  ...
  it('keeps demo data read-only even when it awaits approval', () => {
    render(<ApprovalCard lifecycleState="Awaiting approval" isMock isSubmitting={false} onSubmit={vi.fn()} />)
  ...
  it('submits a live approved decision with comments', () => {
    ...
    render(<ApprovalCard lifecycleState="Awaiting approval" isMock={false} isSubmitting={false} onSubmit={onSubmit} />)
